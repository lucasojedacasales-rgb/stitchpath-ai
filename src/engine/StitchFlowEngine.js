// ============================================
// STITCHFLOW ENGINE - Frontend
// Motor de generación de puntadas para Canvas
// ============================================
...
class StitchFlowEngine {
  ...
  generateFillStitch(polygon, options = {}) {
  ...
  generateSatinStitch(path, options = {}) {
    const opts = { ...this.defaults, ...options };
  ...
  generateRunningStitch(path, options = {}) {
    const opts = { ...this.defaults, ...options };
  ...
  rotatePolygon(polygon, angleDeg) {
...
export default StitchFlowEngine;
